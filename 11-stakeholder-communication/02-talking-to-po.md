...
Story-writing is one of the tasks AI assistance genuinely improves: a model will happily expand a one-line story into thirty plausible acceptance criteria, and POs are already doing this. What it cannot supply is the knowledge that motor total-loss decisions above €25,000 need a countersignature in that specific market, that salvage comes from a named auction feed, or that the register filing has a statutory window — because none of that is in the ticket, and much of it lives only in the heads of the operations staff who do the work today. Generated criteria are plausible, which is more dangerous than vague, because plausible criteria get accepted without the questions being asked. That makes the engineer who asks *who else touches this, what happens when it fails, and where does this number come from* more valuable, not less. Regulated domains keep adding approval tiers and reporting obligations, and each one is a place where a story that looks complete is not.
